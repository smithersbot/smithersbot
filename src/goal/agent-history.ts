...
function sanitizeGithubPushOutcome(
  ...
  return {
    ...
    branch: redactSecretValues(outcome.branch),
    remote: outcome.remote ? truncateSafeExcerpt(outcome.remote) : undefined,
    attempted: outcome.attempted,
    succeeded: outcome.succeeded,
    pushedSha: outcome.pushedSha,
    reviewUrl: outcome.reviewUrl ? truncateSafeExcerpt(outcome.reviewUrl) : undefined,
    message: outcome.message ? truncateSafeExcerpt(outcome.message) : undefined,
