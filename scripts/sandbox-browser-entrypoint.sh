...
CDP_PORT="${SMITHERSBOT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${SMITHERSBOT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${SMITHERSBOT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${SMITHERSBOT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${SMITHERSBOT_BROWSER_HEADLESS:-0}"
